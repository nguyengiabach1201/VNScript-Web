...
function parser(tokens) {
    scriptAfter = 'function viết(e){let terminal = document.getElementById("output");terminal.appendChild(document.createElement("p")).innerHTML = e;};/*function abcxyz(){*/'
    ...
    // scriptAfter += "};try{eval(abcxyz())}catch(error){console.log(error)}"
}
...
canvas.width = canvas.height = screen.width / 2
